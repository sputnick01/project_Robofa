...
public class ShowAllNote extends AppCompatActivity {
    String Server_Ur2 = "http://farshidhabibi.ir/farshid/kivan/Receive.php";
    JSONObject obj;
    JSONArray jsonarray;
    RecyclerView recycler;
    ArrayList<ModleKa> modellist;
    Adapter_Kar homeAdd;
    ...
    private void onload() {
        coordinatorLayout = (CoordinatorLayout) findViewById(R.id.CoordinateNotechannelAllNote);
    ...
    private void Initialize() {
        progressBar = (ProgressBar) findViewById(R.id.spin_kit_channelAllNote);
        recycler = (RecyclerView) findViewById(R.id.RecyclerView_channelAllNote);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    while (count < jsonarray.length()) {
                        ...
                        modellist.add(new ModleKa(Id,Note));
                        final LinearLayoutManager layoutmanager = new LinearLayoutManager(ShowAllNote.this);
                        RecyclerView.LayoutManager rcLayoutManager = layoutmanager;
                        recycler.setLayoutManager(rcLayoutManager);
                        homeAdd = new Adapter_Kar(ShowAllNote.this, modellist);
...
//
        ...
        MySingleton.getInstance(ShowAllNote.this).addtoRequestQueue(stringrequest);
