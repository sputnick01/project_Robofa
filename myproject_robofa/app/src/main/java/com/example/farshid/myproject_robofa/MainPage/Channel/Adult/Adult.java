...
import com.example.farshid.myproject_robofa.MainPage.Channel.Notification.Adapter_Notification;
...
public class Adult extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.adult, container, false);
        Initialize();
//        LoadPage();
        ForRecyclerView();
        return view;
    ...
    private void onload() {
        coordinatorLayout = (CoordinatorLayout) view.findViewById(R.id.CoordinateNotechannelAdult);
    ...
    private void Initialize() {
        progressBar = (ProgressBar) view.findViewById(R.id.spin_kit_channelAdult);
        recycler = (RecyclerView) view.findViewById(R.id.RecyclerView_channelAdult);
        FoldingCube cubeGrid = new FoldingCube();
        progressBar.setIndeterminateDrawable(cubeGrid);
    }
    private void ForRecyclerView() {
        helpher = new DatabaseHelper(getActivity());
        dbList= new ArrayList<DataBaseModle>();
        dbList = helpher.getDataFromDB();
        mRecyclerView = (RecyclerView)view.findViewById(R.id.RecyclerView_channelAdult);
