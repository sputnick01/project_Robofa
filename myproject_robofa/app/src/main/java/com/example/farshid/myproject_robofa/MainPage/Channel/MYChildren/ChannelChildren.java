...
public class ChannelChildren extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_channel_children);
        Initialize();
        LoadPage();
    }
    ...
    private void onload() {
        coordinatorLayout = (CoordinatorLayout)findViewById(R.id.CoordinateNoteChannle);
    ...
    private void Initialize() {
        progressBar = (ProgressBar) findViewById(R.id.spin_kit_channle);
        recycler = (RecyclerView) findViewById(R.id.RecyclerView_Child);
...
//                        modellist.add(new ModleSearchStudent(Note));
                        final LinearLayoutManager layoutmanager = new LinearLayoutManager(ChannelChildren.this);
                        RecyclerView.LayoutManager rcLayoutManager = layoutmanager;
                        recycler.setLayoutManager(rcLayoutManager);
                        homeAdd = new Adapter(ChannelChildren.this, modellist);
...
//
        ...
        MySingleton.getInstance(ChannelChildren.this).addtoRequestQueue(stringrequest);
