...
import com.example.farshid.myproject_robofa.DataBase.Noti.RecyclerNotification;
...
//        LoadPage();
    ...
    private void onload() {
        coordinatorLayout = (CoordinatorLayout) view.findViewById(R.id.CoordinateNoteChannleNotification);
    ...
    private void Initialize() {
        progressBar = (ProgressBar) view.findViewById(R.id.spin_kit_channleNotification);
//        recycler = (RecyclerView) view.findViewById(R.id.RecyclerView_Notification);
    ...
    private void ForRecyclerView() {
        ...
        dbList= new ArrayList<NotificationModle>();
        dbList = helpher.getDataFromDBNoti();
        ...
        mAdapter = new RecyclerNotification(getActivity(),dbList);
...
//                        homeAdd = new Adapter_Notification(getActivity(), modellist);
