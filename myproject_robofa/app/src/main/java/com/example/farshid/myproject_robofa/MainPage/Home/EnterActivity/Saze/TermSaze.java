...
public class TermSaze extends AppCompatActivity implements View.OnClickListener {
    String Term;
    TextView TextTermToolBar;
    private int time_interval = 2000;
    private long oldCurrentTimeMillis;
    Button MainPage_Home_Saze_Practice, MainPage_Home_Chortka_Practice2, MainPage_Home_Chortka_Note, MainPage_Home_Chortka_YourRating;
    String Term2="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_term_saze);
        Initilize();
        SetFont();
        ...
        MainPage_Home_Chortka_YourRating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(TermSaze.this, YourRating.class);
        ...
        MainPage_Home_Chortka_Note.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(TermSaze.this, Note.class);
                in.putExtra("Term", Term2);
    ...
    private void SetFont() {
        ...
        MainPage_Home_Saze_Practice.setTypeface(tf);
    ...
    private void Initilize() {
        ...
        MainPage_Home_Saze_Practice = (Button) findViewById(R.id.MainPage_Home_Saze_Practice);
        MainPage_Home_Chortka_Note = (Button) findViewById(R.id.MainPage_Home_Saze_Note);
        MainPage_Home_Chortka_YourRating = (Button) findViewById(R.id.MainPage_Home_Saze_YourRating);
        MainPage_Home_Chortka_Practice2 = (Button) findViewById(R.id.MainPage_Home_Saze_Practice2);
