...
public class TermZaban extends AppCompatActivity implements View.OnClickListener {
    String Term;
    TextView TextTermToolBar;
    private int time_interval = 2000;
    private long oldCurrentTimeMillis;
    Button MainPage_Home_Zaban_Practice, MainPage_Home_Chortka_Practice2, MainPage_Home_Chortka_Note, MainPage_Home_Chortka_YourRating;
    String Term2="";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_term_zaban);
        Initilize();
        SetFont();
        ...
        MainPage_Home_Chortka_YourRating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(TermZaban.this, YourRating.class);
        ...
        MainPage_Home_Chortka_Note.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(TermZaban.this, Note.class);
                in.putExtra("Term", Term2);
    ...
    private void SetFont() {
        ...
        MainPage_Home_Zaban_Practice.setTypeface(tf);
        MainPage_Home_Chortka_Note.setTypeface(tf);
        MainPage_Home_Chortka_YourRating.setTypeface(tf);
    }


    private void Initilize() {
        TextTermToolBar = (TextView) findViewById(R.id.MainPage_toolbar_title2);
        MainPage_Home_Zaban_Practice = (Button) findViewById(R.id.MainPage_Home_Zaban_Practice);
        MainPage_Home_Chortka_Note = (Button) findViewById(R.id.MainPage_Home_Zaban_Note);
        MainPage_Home_Chortka_YourRating = (Button) findViewById(R.id.MainPage_Home_Zaban_YourRating);
        MainPage_Home_Chortka_Practice2 = (Button) findViewById(R.id.MainPage_Home_Zaban_Practice2);
