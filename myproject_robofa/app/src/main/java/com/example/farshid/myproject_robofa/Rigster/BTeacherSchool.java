...
public class BTeacherSchool extends AppCompatActivity {
    ...
    boolean Trust = false;
    String ClassMe = "";
    String Server_Url = "http://farshidhabibi.ir/farshid/kivan/Rigster_TS2.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bteacher_school);
        Initialize();
        SetAdapter();
...
//                        }
                        StringRequest stringrequest = new StringRequest(Request.Method.POST, Server_Url, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                Toast.makeText(BTeacherSchool.this, "ثبت شد !", Toast.LENGTH_SHORT).show();
                                count = 0;
...
//                                                count = 0;
                        ...
                        MySingleton.getInstance(BTeacherSchool.this).addtoRequestQueue(stringrequest);
                    }
                } else {
                    Toast.makeText(BTeacherSchool.this, "فیلد های لازم را پر کنید!", Toast.LENGTH_SHORT).show();
                }
            }
...
//            count=0;
    ...
    private boolean Trust() {
        ...
        if (EDPhoneNumber.getText().toString().isEmpty() || EDMaliKey.getText().toString().isEmpty() || EDName.getText().toString().isEmpty() ||
                ...
                ||
                Document.getText().toString().trim().equals("کلاس درس")) {
            Trust = false;
    ...
    private void SelectImage() {
        final Dialog dialog1 = new Dialog(BTeacherSchool.this);
//ست کردن لایه سفرشی به الرت دیالوگ
        dialog1.setContentView(R.layout.layoutcamera);
        dialog1.setTitle("درج عکس!!");
        Button button = dialog1.findViewById(R.id.back);
        Button button2 = dialog1.findViewById(R.id.Gallary);
        Button button3 = dialog1.findViewById(R.id.Camera);
    ...
    private void Initialize() {
        circularProgressButton = (Button) findViewById(R.id.BTeacherschool_ButtonSubmit);
        EDPhoneNumber = (EditText) findViewById(R.id.BTeacherschool_EditText_PhoneNumber);
        EDMaliKey = (EditText) findViewById(R.id.BTeacherschool_EditText_MaliKey);
        EDName = (EditText) findViewById(R.id.BTeacherschool_EditText_Name);
        EDlastName = (EditText) findViewById(R.id.BTeacherschool_EditText_LastName);
        relativeLayout = (RelativeLayout) findViewById(R.id.TeacherRelativeLayout211);
        EDClass = (EditText) findViewById(R.id.BTeacherschool_EditText_KindClass);
        KindClass = (BetterSpinner) findViewById(R.id.BTeacherschool_EditText_KindClass);
        Document = (BetterSpinner) findViewById(R.id.BTeacherschool_Ducument);
        MainPage_Profile_CircularImageView = (CircularImageView) findViewById(R.id.BTeacherschool_Profile_CircularImageView);
        MainPage_Rigster_EditText_Breth = (EditText) findViewById(R.id.BTeacherschool_EditText_Breth);
        School = (BetterSpinner) findViewById(R.id.BTeacherschool_School);
    }
...
//        };
        ArrayAdapter<String> adapter_Document_Student = new ArrayAdapter<String>(BTeacherSchool.this,
                android.R.layout.simple_dropdown_item_1line, Document_Student);
        Document.setAdapter(adapter_Document_Student);

        ArrayAdapter<String> Sch = new ArrayAdapter<String>(BTeacherSchool.this,
                android.R.layout.simple_dropdown_item_1line, Schoo);
        School.setAdapter(Sch);

        ArrayAdapter<String> adapter_Document_Teacher = new ArrayAdapter<String>(BTeacherSchool.this,
