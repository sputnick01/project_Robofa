...
import com.example.farshid.myproject_robofa.MainPage.Home.EnterActivity.Chortka.Note.SendMassageForTeacher;
...
public class tabNoteStudent extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.tabnote_student, container, false);
        Initialize();
...
//مقدار دهی مقادیر
    private void Initialize() {
        ...
        recycler = (RecyclerView) view.findViewById(R.id.MainPage_Chortka_RecyclerView);
        FoldingCube cubeGrid = new FoldingCube();
        progressBar.setIndeterminateDrawable(cubeGrid);
    }

//گرفتن اطلاعات از سرور برای موسسه
